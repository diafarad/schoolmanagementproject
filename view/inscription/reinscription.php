        ...
        <form method="post" id="form_reinscription">
            <div class="eleve" style="margin-top: 10px; box-shadow: 4px 4px 4px gray; border: 1px ridge gray">
                ...
                <div style="margin-left: 15px; margin-right: 15px" class="form-group">
                    ...
                    <input class="form-control" type="text" name="mail" id="mail" placeholder="Mail" readonly>
                </div>
                <div style="margin-left: 15px; margin-right: 15px" class="form-group">
                    <label class="control-label">Téléphone</label>
                    <input class="form-control" type="text" name="tel" id="tel" placeholder="Téléphone" readonly>
                </div>
            ...
            <div class="classe" style="margin-top: 10px; box-shadow: 4px 4px 4px gray; border: 1px ridge gray">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="serie" name="serie" placeholder="Série" readonly>
                    </div>
                </div>
                <div class="modal-footer"></div>
            </div>
...
<script type="application/javascript">
    ...
    $(document).ready(function () {
        $("#classe").change(function () {
            ...
            $idclasse = $("#classe").val();
            $.ajax({
                url: "<?php echo base_url();?>controller/ClasseController.php?idc="+$idclasse,
                dataType: "json",
    ...
    $(document).ready(function () {
        $("#mat").change(function () {
            ...
            $mat = $("#mat").val();
            $.ajax({
                url: "<?php echo base_url();?>controller/EleveController.php?mat="+$mat,
                dataType: "json",
                success: function (data) {
                    $('#prenom').val(data['2']);
                    $('#nom').val(data['1']);
    ...
    $('#valider').click(function () {
        ...
        if(err_mat != '' || err_classe != ''){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>controller/InscriptionController.php",
                method: "POST",
                data: form_data,
                dataType: "text",
                success: function(data) {
