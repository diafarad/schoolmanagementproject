...
<script type="application/javascript">
    ...
    $('#valider').click(function () {
        ...
        if($('#mail').val() == ''){
            err_mail = 'Saisir le mail';
            $('#err_mail').text(err_mail);
        ...
        if($('#tel').val() == ''){
            err_tel = 'Saisir le numéro de téléphone';
            $('#err_tel').text(err_tel);
        ...
        if(err_prenom != '' || err_nom != '' || err_date != '' || err_lieu != '' || err_mail != '' || err_tel != '' || err_sexe != '' || err_classe != ''){
            return false;
        }else {
