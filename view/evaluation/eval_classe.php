...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>public/jquery-ui-1.12.1/jquery-ui-1.12.1/jquery-ui.css"/>
...
<div class="modal fade" id="mynoteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="width:1005px;">
        <div class="modal-content" >
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel" align="center">Notes évaluation</h4>
...
<script>
    ...
    $(document).ready(function () {
        $('#list_notes').on('submit', function () {
            ...
            if(count_data > 0){
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>controller/NoteController.php",
                    method: "POST",
                    data: form_data,
    ...
    $(document).on( "click", '.addnote_button',function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>controller/EvaluationController.php?idcl_note="+id+"&anneeAc_note="+anneeEncours+"&idEval="+idEv+"&sem="+sem,
            dataType: "text",
            success: function (data) {
                $('#lesnotes > tbody').empty();
                if(data){
    ...
    $(document).on( "click", '.lesnotes_button',function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>controller/EvaluationController.php?ideval_note="+idev+"&anneeAcad_note="+anEncours+"&sem_note="+sem+"&idcl_note="+cl,
            dataType: "text",
            success: function (data) {
                $('#listnotes > tbody').empty();
                if(data){
    ...
    $(document).on( "change", '#semestre',function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>controller/EvaluationController.php?classe_id="+id+"&anneeAc="+anneeAc+"&sem="+semestre,
            dataType: "text",
            success: function (data) {
                $('#resultEval > tbody').empty();
                if(data){
