...
$connect = new PDO("mysql:host=localhost;dbname=db_school;charset=utf8","root","");
...
try{
    ...
    $sqlverif = "SELECT el.mat, el.prenom,n.valeur FROM note n, evaluation e, eleve el, classe c
