...
<nav>
    <ul>
        ...
        <li><a href="<?php echo base_url().'?page=classe' ?>" style="font-weight: bold">Classe</a></li>
        <li class="deroulant"><a style="font-weight: bold">Enseignements&ensp;</a>
            <ul class="sous">
                <li><a href="<?php echo base_url().'?page=matiere' ?>" style="font-weight: bold">Matières</a></li>
                <li><a href="<?php echo base_url().'?page=professeur' ?>" style="font-weight: bold">Professeurs</a></li>
                <li><a href="<?php echo base_url().'?page=cours' ?>" style="font-weight: bold">Cours</a></li>
            </ul>
        </li>
        <li class="deroulant"><a style="font-weight: bold">Ré/Inscription&ensp;</a>
            <ul class="sous">
                <li><a href="<?php echo base_url().'?page=inscription' ?>" style="font-weight: bold">Inscription</a></li>
        ...
        <li><a href="<?php echo base_url().'?page=statistique' ?>" style="font-weight: bold">Statistiques</a></li>
    </ul>
</nav>
